#!/usr/bin/python3
# Getting some dozens of Cochrane PLSs from Wiley's site (from the first Google 100 hits)
...
if len(sys.argv)!=3 :
   print ("Usage: scrape-pls-from-cochrane.py languagecode1 languagecode2")
   exit()
...
# get results page for selected languages (100 results)
   ...
   page = requests.get("https://www.google.cat/search?q=" + partialquery + " " + langnames[lang1] + " " + langnames[lang2] + "&num=100")
...
# If both snippets are not empty, write them to conveniently named files, and tidy them using command-line tidy
